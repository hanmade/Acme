...
<div class="navbar-inner">
  <a class="brand" href="#"><?php echo $record_count; ?> Registered Users</a>
  <form action="/admin/registered_users/create" method="post" class="navbar-form form-inline pull-left">
	<button type="submit" class="btn">Create User</button>
  </form>

  <form action="/admin/registered_users/ulist" method="post"class="navbar-form form-inline pull-right">
...
{
	echo "<th>".anchor("admin/registered_users/ulist/1/$order", 'ID', '')."</th>";
	echo "<th>".anchor("admin/registered_users/ulist/7/$order", 'Date Modified', '')."</th>";
	echo "<th>".anchor("admin/registered_users/ulist/8/$order", 'IP Address', '')."</th>";
}
?>

<th><?php echo anchor("admin/registered_users/ulist/2/$order", 'Email', '')?></th>
<th><?php echo anchor("admin/registered_users/ulist/3/$order", 'Name', '')?></th>
<th>Address</th>
<th><?php echo anchor("admin/registered_users/ulist/4/$order", 'City', '')?></th>
<th><?php echo anchor("admin/registered_users/ulist/5/$order", 'State', '')?></th>
<th><?php echo anchor("admin/registered_users/ulist/6/$order", 'Zip Code', '')?></th>
<?php
