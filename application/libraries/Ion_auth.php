...
class Ion_auth
{
	 ...
	 * @return bool
	 * @author Steve Hanlon
	 * reserved for the most dangerous of admin tasks
	 * requires a separate god-mode login cred as there are no
	 * cascading roles in ion auth... as of yet...
	 **/
	public function is_god()
	{
		$god_group = $this->ci->config->item('god_group', 'ion_auth');
		$user_group  = $this->ci->session->userdata('group');

		return $user_group == $god_group;
	}
